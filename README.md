...
- подробные Modules 1–2 с теорией, пошаговой практикой, словарём, итоговыми
  проверками и контекстным чатом; Module 2 содержит 7 уроков о роде, числе,
  назывании и наличии существительных;
